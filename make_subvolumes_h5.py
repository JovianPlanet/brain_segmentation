...
'''
En este codigo se crean los subvolumenes para entrenar la red UNET3D a partir del archivo h5
donde se encuentran almacenadas todas las imagenes de las bases de datos
'''
...
feat_out_dir = os.path.join('dataset', '3D', 'feat') #'dataset/3D/feat/'
mask_out_dir = os.path.join('dataset', '3D', 'mask') #'dataset/3D/mask/'
val_feat_out_dir = os.path.join('dataset', '3D', 'val_feat') #'dataset/3D/val_feat/'
val_mask_out_dir = os.path.join('dataset', '3D', 'val_mask') #'dataset/3D/val_mask/'
test_feat_out_dir = os.path.join('dataset', '3D', 'test_feat') #'dataset/3D/test_feat/'
test_mask_out_dir = os.path.join('dataset', '3D', 'test_mask') #'dataset/3D/test_mask/'
